...
// function percentage($arr_numbers){
// 	//input: [20,30,2,10] output = [32,48,3,16] (%)
// 	$count_arr = count($arr_numbers);
// 	$summ = 0;
// 	for($i=0; $i <= $count_arr; $i++){
// 		$summ+=(int)$arr_numbers[$i];
// 	}
// 	// echo "Summ: $summ<br>";
// 	$arr_percent_number = array();
// 	for($i=0; $i < $count_arr; $i++){
// 		$percent_number = round(((int)$arr_numbers[$i]/$summ) * 100);
// 		$arr_percent_number[] = $percent_number;
// 	}
	// var_dump($arr_percent_number);
// 	return $arr_percent_number;
// }
// Statistic
